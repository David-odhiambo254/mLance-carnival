...
Route::middleware('admin')->group(function () {
    ...
    Route::controller('CategoryController')->prefix('category')->name('category.')->group(function () {
        ...
        //Pricing-form-generate
        Route::get('pricing/{id}', 'pricingFormGenerate')->name('pricing');
        Route::post('pricing/store/{id}', 'pricingFormGenerateUpdate')->name('pricing.store');
    });
    //Subcategory
    ...
    Route::controller('PricingController')->prefix('pricing')->name('pricing.')->group(function () {
        Route::get('/', 'index')->name('index');
        Route::post('update/{id}', 'update')->name('update');
    });

    // gigs
    Route::controller('ManageGigController')->prefix('gig')->name('gig.')->group(function () {
    ...
    // projects
    Route::controller('ManageProjectController')->prefix('project')->name('project.')->group(function () {
        Route::get('/all', 'index')->name('index');
        Route::get('details/{id}', 'details')->name('details');
