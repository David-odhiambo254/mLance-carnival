...
class AdminController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        $gig['total_gigs']          = Gig::count();
        $gig['total_approved_gigs'] = Gig::approved()->count();
        $gig['total_pending_gigs']  = Gig::pending()->count();
        $gig['total_rejected_gigs'] = Gig::rejected()->count();

        $project['total_projects']           = Project::count();
        $project['total_pending_projects']   = Project::pending()->count();
        $project['total_accepted_projects']  = Project::accepted()->count();
        $project['total_rejected_projects']  = Project::rejected()->count();
        $project['total_reported_projects']  = Project::reported()->count();
        $project['total_completed_projects'] = Project::completed()->count();
        ...
        return view('admin.dashboard', compact('pageTitle', 'widget', "gig", "project", 'chart', 'deposit', 'withdrawals'));
    }
