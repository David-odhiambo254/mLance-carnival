...
class GeneralSettingController extends Controller
{
    ...
    public function generalUpdate(Request $request)
    {
        $request->validate([
            ...
            'buyer_percent_fee'  => 'required|numeric',
            'buyer_fixed_fee'    => 'required|numeric',
            'seller_percent_fee' => 'required|numeric',
            'seller_fixed_fee'   => 'required|numeric',
        ]);
        ...
        $general->buyer_percent_fee = $request->buyer_percent_fee;
        $general->buyer_fixed_fee   = $request->buyer_fixed_fee;

        $general->seller_percent_fee = $request->seller_percent_fee;
        $general->seller_fixed_fee   = $request->seller_fixed_fee;
        $general->save();
