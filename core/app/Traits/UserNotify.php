...
trait UserNotify
{
    public static function notifyToUser(){
        return [
            ...
            'pendingOrderUsers'      => 'Pending Order Users',
            'acceptedOrderUsers'     => 'Accepted Order Users',
            'rejectedOrderUsers'     => 'Rejected Order Users',
            'completedOrderUsers'    => 'Completed Order Users',
            'reportedOrderUsers'     => 'Reported Order Users',
        ];
    }
    ...
    public function scopePendingOrderUsers($query)
    {
    ...
    public function scopeAcceptedOrderUsers($query)
    {
        return $query->whereHas('orders', function ($q) {
            $q->accepted();
        });
    ...
    public function scopeRejectedOrderUsers($query)
    {
        return $query->whereHas('orders', function ($q) {
            $q->rejected();
        });
    ...
    public function scopeCompletedOrderUsers($query)
    {
        return $query->whereHas('orders', function ($q) {
            $q->completed();
        });
    ...
    public function scopeReportedOrderUsers($query)
    {
        return $query->whereHas('orders', function ($q) {
            $q->reported();
        });
