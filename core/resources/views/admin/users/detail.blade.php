        ...
        <div class="col-12">
            ...
            <div class="row gy-4">
                ...
                <div class="col-xxl-3 col-sm-6">
                    <x-widget value="{{ $project['total_projects'] }}" title="Total Projects" style="6" bg="primary" icon="las la-list-ol" link="{{ route('admin.project.index') }}?search={{ $user->username }}" />
                </div>
                <div class="col-xxl-3 col-sm-6">
                    <x-widget value="{{ $project['total_pending_projects'] }}" title="Pending Projects" style="6" bg="warning" icon="las la-spinner" link="{{ route('admin.project.pending') }}?search={{ $user->username }}" />
                </div>
                <div class="col-xxl-3 col-sm-6">
                    <x-widget value="{{ $project['total_accepted_projects'] }}" title="Accepted Projects" style="6" bg="success" icon="la la-check-double" link="{{ route('admin.project.accepted') }}?search={{ $user->username }}" />
                </div>
                <div class="col-xxl-3 col-sm-6">
                    <x-widget value="{{ $project['total_rejected_projects'] }}" title="Rejected Projects" style="6" bg="danger" icon="las la-times-circle" link="{{ route('admin.project.rejected') }}?search={{ $user->username }}" />
                </div>


                <div class="col-xxl-3 col-sm-6">
                    <x-widget value="{{ $project['total_reported_projects'] }}" title="Reported Projects" style="7" bg="danger" icon="la la-ban" link="{{ route('admin.project.reported') }}?search={{ $user->username }}" />
                </div>
                <div class="col-xxl-3 col-sm-6">
                    <x-widget value="{{ $project['total_completed_projects'] }}" title="Completed Projects" style="7" bg="success" icon="las la-check-circle" link="{{ route('admin.project.completed') }}?search={{ $user->username }}" />
                </div>

                <div class="col-xxl-3 col-sm-6">
                    <x-widget value="{{ $gig['total_approved_gigs'] }}" title="Approved Gigs" style="7" bg="primary" icon="las la-list-ul" link="{{ route('admin.gig.approved') }}?search={{ $user->username }}" />
                </div>
                <div class="col-xxl-3 col-sm-6">
                    <x-widget value="{{ $gig['total_pending_gigs'] }}" title="Pending Gigs" style="7" bg="warning" icon="las la-spinner" link="{{ route('admin.gig.pending') }}?search={{ $user->username }}" />
                </div>

                <div class="col-xxl-3 col-sm-6">
                    <x-widget value="{{ showAmount($user->balance) }}" title="Balance" style="2" color="primary" icon="las la-money-bill-wave-alt" link="{{ route('admin.report.transaction') }}?search={{ $user->username }}" />
                </div>

                <div class="col-xxl-3 col-sm-6">
                    <x-widget value="{{ showAmount($totalDeposit) }}" title="Deposits" style="2" color="success" icon="las la-wallet" link="{{ route('admin.deposit.list') }}?search={{ $user->username }}" />
                </div>

                <div class="col-xxl-3 col-sm-6">
                    <x-widget value="{{ showAmount($totalWithdrawals) }}" title="Withdrawals" style="2" color="danger" icon="la la-wallet" link="{{ route('admin.withdraw.data.all') }}?search={{ $user->username }}" />
                </div>
                <div class="col-xxl-3 col-sm-6">
                    <x-widget value="{{ $totalTransaction }}" title="Transactions" style="2" color="primary" icon="las la-exchange-alt" link="{{ route('admin.report.transaction') }}?search={{ $user->username }}" />
                </div>
