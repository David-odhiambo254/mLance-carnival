            ...
            <form class="{{ $formClassName ?? 'generate-form' }}">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select name="form_type" class="form-control select2" data-minimum-results-for-search="-1"
                            required>
                    ...
                    <div class="form-group">
                        ...
                        <select name="is_required" class="form-control select2" data-minimum-results-for-search="-1"
                            required>
                            <option value="">@lang('Select One')</option>
                    ...
                    <div class="form-group">
                        ...
                        <select name="form_width" class="form-control select2" data-minimum-results-for-search="-1"
                            required>
                            <option value="">@lang('Select One')</option>
                ...
                <div class="modal-footer">
                    <button type="submit"
                        class="btn btn--primary w-100 h-45 generatorSubmit">@lang('Add')</button>
                </div>
            </form>
        </div>
    </div>
